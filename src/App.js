      ...
      <div className="App">
        ...
        <div id="vidtop-content">
          ...
          <div className="interact-box">
            <img src={logo} alt=""/>
            <h1><span style={{color: 'rgb(188, 52, 38)'}}>England</span>Footage.com</h1>
        ...
        <div className="info-sec">
          <section>
            <h1>England <a className="rf" href="https://en.wikipedia.org/wiki/Royalty-free">Royalty-Free</a> Stock Footage Marketplace (contact us for 4K)</h1>
            <h4 className="sub-banner">EnglandFootage.com is a division of <a style={{textDecoration:'none', color: '#999'}} href="https://stockfootage.com/">StockFootage.com</a></h4>
          </section>
          ...
          <section className="contributors">
            ...
            <br/>
            <p>Download high quality royalty-free 4K and HD stock video footage clips from the post popular travel locations in England including:  Big Ben, St. Paul's Cathedral, Picadilly, London, Westminster, busy streets, and phone booths.  Contact us to learn more about selling your own stock footage through our online community.  </p>
          </section>
          <br/>
        </div>
        <Footer/>
